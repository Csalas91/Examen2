<%@ Page Title="" Language="C#" MasterPageFile="~/menu.Master" AutoEventWireup="true" CodeBehind="Equipo.aspx.cs" Inherits="Examen2.Equipo1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div  class="container text-center">

    <h1 style="color: #FFFFFF"> Equipos </h1>
 ...
 <div class="container text-center" style="color: #FFFFFF">
     ID Usuario:<asp:TextBox ID="tId" class="form-control" runat="server" ></asp:TextBox>   
     Equipo:<asp:TextBox ID="tequipo" class="form-control" runat="server" ></asp:TextBox>
